...
/**
 * Interface for constructing where-clause and having-clause
 * conditions.
 * Instances of PredicateOperand are used in constructing predicates
 * passed to the where or having methods.
 */
public interface PredicateOperand {
	/**
	 * Create a predicate for testing equality with the
	 * specified argument.
	 * @param arg - PredicateOperand instance or parameter
	...
	/**
	 * Create a predicate for testing inequality with the
	 * specified argument.
	 * @param arg - PredicateOperand instance or parameter
	 * @return conditional predicate
	 */
	...
	/**
	 * Create a predicate for testing whether the PredicateOperand
	...
	/**
	 * Create a predicate for testing whether the PredicateOperand
	 * lies between (inclusive) the two arguments.
	 * @param arg1 - PredicateOperand instance or parameter
	 * @param arg2 - PredicateOperand instance or parameter
	 * @return conditional predicate
	 */
