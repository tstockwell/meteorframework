...
public class MeteorInfoBuilder {
	...
	public String getMeteorInfo() {
		...
		if (!"com.googlecode.meteorframework".equals(packageName)) {
			writer.println("import com.googlecode.meteorframework.JavaMeteorMetadataProvider;");
			writer.println("import com.googlecode.meteorframework.Scope;");
		}
		writer.println("import com.googlecode.meteorframework.annotation.Generated;\n");
...
//				continue;
		 ...
		 */ 
		writer.println("\n");
		writer.println("\tpublic void contributeMetaData(com.googlecode.meteorframework.Scope scope) {");
