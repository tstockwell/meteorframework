...
public class ParameterTypeSpecializer extends BaseSpecializer {
	...
	static String getUniqueTypeIdentifier(Object arg) {
		...
		if (impl != null) {
			com.googlecode.meteorframework.Type type= impl.getType();
			id= type.getJavaType().getName();
			
			Set<com.googlecode.meteorframework.Type> extensionTypes= type.getExtensions();
			if (extensionTypes != null)
				for (com.googlecode.meteorframework.Type xType : extensionTypes) {
