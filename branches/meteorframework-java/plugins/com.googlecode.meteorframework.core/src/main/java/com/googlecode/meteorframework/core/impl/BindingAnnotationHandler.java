...
@ProcessesAnnotations(Binding.class)
@ModelElement public class BindingAnnotationHandler implements ModelAnnotationHandler {
	
	private Scope _scope;
	private Object _target;
	private com.googlecode.meteorframework.core.annotation.Binding _annotation;
	
	public boolean initialize(Scope scope, Object p_annotation, Object p_target) {

		_scope= scope;
		_target= p_target;
		_annotation= (com.googlecode.meteorframework.core.annotation.Binding) p_annotation;
